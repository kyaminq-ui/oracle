...
/// Assigne ici les sous-sprites importés depuis Assets/_Game/Sprites/NewTilesV2 (Floor, Obstacles, Decorations, Borders).
...
///   Compression       → None
///   Pixels Per Unit   → 64 (cohérent avec NewTilesV2 64×64 et GridConfig.tileWidth 1)
/// </summary>
...
public class TileSpriteRegistry : ScriptableObject
{
    ...
    [Tooltip("Glisse les sprites obstacles (dossier Obstacles de NewTilesV2).")]
